	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Black", "Blue", "Green", "Purple")),
			...
			array( "name" => "Use New Thumbnail Resizing ( if possible )",
				   "id" => $shortname."_new_thumb_method",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "Resizes images using wordpress built-in functions. It doesn't work with posts that have etcrop custom field and images hosted on external servers. If thumbnails are not resized properly, try deactivating this option."),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Homepage Quote",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "This controls the two-lined quote that appears on the homepage above the featured slider."),
			
			array( "type" => "clearfix",),
			
			array( "name" => "Quote Line 1",
                   "id" => $shortname."_quote_one",
                   "std" => "Modest theme is just a humble design with big intentions.",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),
			
			array( "name" => "Quote Line 2",
                   "id" => $shortname."_quote_two",
                   "std" => "Ut a nunc ornare velit ornare ullamcorper sed eu magna.",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),
			...
			array( "name" => "Gallery Category on Homepage",
                   "id" => $shortname."_work_cat",
                   "type" => "select",
			       "options" => $site_cats,
				   "desc" => "desc."),
			
			array( "name" => "Number Of Gallery Items on Homepage",
                   "id" => $shortname."_work_number",
                   "std" => "6",
                   "type" => "text",
				   "desc" => "desc."),
			...
			array( "name" => "Use Content Area 3 Page",
                   "id" => $shortname."_use_third_page",
                   "type" => "checkbox",
                   "std" => "false",
                   "desc" => "desc."),
		...
		array( "name" => "general-3",
			...
			array( "name" => "Automatic Slider Animation",
                   "id" => $shortname."_featured_slider_auto",
                   "type" => "checkbox",
                   "std" => "false",
			...
			array( "name" => "Automatic Animation Speed (in ms)",
                   "id" => $shortname."_featured_auto_speed",
                   "type" => "text",
			       "std" => "7000",
