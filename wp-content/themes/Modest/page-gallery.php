				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div class="et_pt_gallery_entry">
						<div class="et_pt_item_image">
							...
							<a class="zoom-icon fancybox" title="<?php the_title(); ?>" rel="gallery" href="<?php echo($thumbnail['fullpath']); ?>"><?php _e('Zoom in','Modest'); ?></a>
							<a class="more-icon" href="<?php the_permalink(); ?>"><?php _e('Read more','Modest'); ?></a>
